...
export default function ExecutionViewer({
    ...
    useEffect(() => {
        // While running we auto-elect the current running phae in the sidebar
        const phases = query.data?.phases || [];
        if (isRunning) {
            // Seelct the last executed phase
      ...
      <div className='flex w-full h-full'>
            ...
            {!isRunning && selectedPhase && phaseDetails.data && (
                <div className="flex flex-col py-4 container gap-4 overflow-auto">
                    ...
                    <ParamterViewer title="Outputs" subtitle = "Outputs generated by this phase" paramsJson = {phaseDetails.data.outputs} />
            ...
            <CardContent className='py-4'>
                <div className="flex flex-col gap-2">
                    {(!params || Object.keys(params).length === 0) && (
                        <p className="text-sm">No paramters generated by this phase</p>
                    )}
